      ...
      <div className="mx-auto max-w-4xl px-4 pt-24 pb-20">
        ...
        {loading ? (
          ...
          <div className="glass rounded-xl overflow-hidden">
            <div className="grid grid-cols-12 gap-4 px-6 py-4 border-b border-border text-sm text-muted-foreground">
            ...
            {globalRank.map((entry) => (
              <div
                key={entry.rank}
                className="grid grid-cols-12 gap-4 px-6 py-4 border-b border-border last:border-0 hover:bg-muted/50 transition-colors"
              >
                ...
                <div className="col-span-3 flex items-center justify-end">
                  <span className="text-sm text-muted-foreground">{entry.solvedCount}</span>
                </div>
              </div>
            ))}
          </div>
